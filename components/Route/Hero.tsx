...
const Hero = (props: Props) => {
    return (
        <div className="w-full md:min-h-screen flex items-center justify-center overflow-hidden">
            <div>
                <h1 className="font-Montserrat text-4xl md:text-5xl py-5 xl:text-7xl 2xl:text-8xl font-[700] text-center xl:leading-[80px] 2xl:leading-[100px] md:mt-20">
                ...
                <div className="w-screen mb-5 md:mb-20 relative">
