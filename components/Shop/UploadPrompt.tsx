                    ...
                    >
                        {promptData.images.length !== 0 ? (
                            ...
                            <span className="text-white">
                                Drag and drop your prompt images here or click
                                to browse
                            </span>
                        )}
                    </label>
                    ...
                    >
                        {promptData.attachments.length !== 0 ? (
                            <div className="flex items-center">
                                ...
                                <span
                                    className={`${styles.label} pl-2 !text-2xl pt-1`}
                                >
                                    {promptData?.attachments?.length}{" "}
                                    {promptData?.attachments?.length > 1
                                        ? "files"
                                        : "file"}
                                </span>
                            </div>
                            ...
                            <span className="text-white">
                                Drag and drop your prompt files here or click to
                                browse
                            </span>
                        )}
                    </label>
